...
function emailVerified(u: VerificationFlags): boolean | undefined {
  return u.email_verified ?? u.emailVerified;
}

function phoneVerified(u: VerificationFlags): boolean | undefined {
...
export function isAccountVerified(
  user: VerificationFlags | null | undefined,
): boolean {
 ...
 */
export function isVerificationKnown(
  user: VerificationFlags | null | undefined,
): boolean {
  if (!user) return false;
  return emailVerified(user) !== undefined || phoneVerified(user) !== undefined;
}
